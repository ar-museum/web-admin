...
@section('content')
                                ...
                                @foreach ($medias as $media)
                                    @if (strpos($media->path, 'uploads' . DIRECTORY_SEPARATOR . 'photo') !== false)
                                        <tr>
                                            ...
                                            <td>
                                                @if ((strpos($media->path, DIRECTORY_SEPARATOR . 'photo'. DIRECTORY_SEPARATOR) !== false) and (strpos($media->path, DIRECTORY_SEPARATOR . 'games'. DIRECTORY_SEPARATOR) == false))
                                                    <?php
    ...
    <div class="row">
        <div class="col-md-12">
            <section class="panel">
                <header class="panel-heading">Photo games
                    <span class="tools pull-right">
                <a href="javascript:;" class="fa fa-chevron-down"></a>
             </span>
                </header>
                <div class="panel-body">
                    @if (count($medias))
                        <div class="adv-table">
                            <table class="display table table-hover table-bordered table-striped" id="photoGames">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Previzualizare</th>
